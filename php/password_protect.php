...
define('LOGOUT_URL', 'http://www.test.local/');
...
// This parameter is a query string parameter that is sent to the main page when editing
define('ADMIN_URL', 'http://test.local/?admin=true')
